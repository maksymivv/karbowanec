...
const size_t   CRYPTONOTE_TX_SPENDABLE_AGE                   = 1;
...
const uint64_t STAKE_BASE_TERM                               = CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW;
const uint64_t MINIMUM_STAKE                                 = UINT64_C(100) * COIN;
...
const uint32_t UPGRADE_HEIGHT_V5                             = 448567;
