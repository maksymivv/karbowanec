...
const int      MULTI_DIFFICULTY_ALGO_FACTOR_CN               = 256;
const int      MULTI_DIFFICULTY_ALGO_FACTOR_CN_GPU           = 3;
const int      MULTI_DIFFICULTY_ALGO_FACTOR_CN_POWER         = 1;
...
const uint32_t UPGRADE_HEIGHT_V5                             = 391650;
