...
const size_t   CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW_V1       = 5; // TESTNET //EXPECTED_NUMBER_OF_BLOCKS_PER_DAY;
...
// MONEY_SUPPLY - total number of coins to be generated before tail emission
...
const uint64_t STAKE_EMISSION_FRACTION                       = 128; // part of supply engaged in stake mining, i.e. 4 stands for 25%
...
const uint32_t UPGRADE_HEIGHT_V5                             = 423000;
