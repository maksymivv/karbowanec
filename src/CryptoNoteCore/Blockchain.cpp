...
bool Blockchain::getBlockLongHash(Crypto::cn_context &context, const Block& b, Crypto::Hash& res) {
  ...
  for (uint32_t i = 0; i < ITER; i++) {
    ...
    *hasht_64_2 *= *hashi1_64_2; *hasht_64_3 *= *hashi1_64_3;
    ...
    hashIter1 = getBlockIdByHeight(height_5);
    *hasht_64_0 -= *hashi0_64_0; *hasht_64_1 -= *hashi0_64_1;
    *hasht_64_2 -= *hashi0_64_2; *hasht_64_3 -= *hashi0_64_3;
    *hasht_64_0 -= *hashi1_64_0; *hasht_64_1 -= *hashi1_64_1;
    *hasht_64_2 -= *hashi1_64_2; *hasht_64_3 -= *hashi1_64_3;
    hashIter0 = getBlockIdByHeight(height_6);
    hashIter1 = getBlockIdByHeight(height_7);
    *hasht_64_0 ^= *hashi0_64_0; *hasht_64_1 ^= *hashi0_64_1;
    *hasht_64_2 ^= *hashi0_64_2; *hasht_64_3 ^= *hashi0_64_3;
    *hasht_64_0 ^= *hashi1_64_0; *hasht_64_1 ^= *hashi1_64_1;
    *hasht_64_2 ^= *hashi1_64_2; *hasht_64_3 ^= *hashi1_64_3;
    ...
    *hasht_64_0 = ((uint64_t)hasht_64_0 << (uint64_t)height_0) | ((uint64_t)hasht_64_0 << (uint64_t)height_4);
    *hasht_64_1 = ((uint64_t)hasht_64_1 << (uint64_t)height_1) | ((uint64_t)hasht_64_1 << (uint64_t)height_5);
    *hasht_64_2 = ((uint64_t)hasht_64_2 << (uint64_t)height_2) | ((uint64_t)hasht_64_2 << (uint64_t)height_6);
    *hasht_64_3 = ((uint64_t)hasht_64_3 << (uint64_t)height_3) | ((uint64_t)hasht_64_3 << (uint64_t)height_7);
  }
  ...
  // Get the corresponding 8 blocks from blockchain based on phase 1
  // and throw them into the pot too

  std::vector<uint64_t> heights;

  heights.push_back(height_0);
  heights.push_back(height_1);
  heights.push_back(height_2);
  heights.push_back(height_3);
  heights.push_back(height_4);
  heights.push_back(height_5);
  heights.push_back(height_6);
  heights.push_back(height_7);
