...
bool Blockchain::getBlockLongHash(Crypto::cn_context &context, const Block& b, Crypto::Hash& res) {
	...
	// Sanity Check
	if (b.majorVersion < CryptoNote::BLOCK_MAJOR_VERSION_5) return get_block_longhash(context, b, res);
	BinaryArray bd;
	...
	uint8_t*  hashi0_8    = (uint8_t*)hashIter0;
	uint64_t* hashi0_64_0 = (uint64_t*)hashIter0;
	uint64_t* hashi0_64_1 = &((uint64_t*)hashIter0)[1];
	uint64_t* hashi0_64_2 = &((uint64_t*)hashIter0)[2];
	uint64_t* hashi0_64_3 = &((uint64_t*)hashIter0)[3];
	uint64_t* hashi1_64_0 = (uint64_t*)hashIter1;
	uint64_t* hashi1_64_1 = &((uint64_t*)hashIter1)[1];
	uint64_t* hashi1_64_2 = &((uint64_t*)hashIter1)[2];
	uint64_t* hashi1_64_3 = &((uint64_t*)hashIter1)[3];
	uint32_t* hasht_32    = (uint32_t*)hashInit;
	uint64_t* hasht_64_0  = (uint64_t*)hashInit;
	uint64_t* hasht_64_1  = &((uint64_t*)hashInit)[1];
	uint64_t* hasht_64_2  = &((uint64_t*)hashInit)[2];
	uint64_t* hasht_64_3  = &((uint64_t*)hashInit)[3];
	uint32_t  height_0    = 0;
	uint32_t  height_1    = 0;
	uint32_t  height_2    = 0;
	uint32_t  height_3    = 0;
	...
	// Phase 1: Hashing the current blockdata
	cn_fast_hash(bd.data(), bd.size(), hashInit);
	
	// Phase 2: Performing ASIC, GPU, Botnet resistant (assymetric) hash
	// Necessary to have a constant, to fight those in the beginning
	// when a chain is relatively small; and in the end, when a chain grows
	// slower than hardware improves.
	// TODO

	// Phase 3: Blockchain Specific Operations
	// Get the corresponding 32 blocks from blockchain based on preparatory hash_1
	// and throw them into the pot too
	for(uint32_t i=0; i<ITER;i++){
		crc32p( hasht_32   , &height_0); crc32p(&hasht_32[1], &height_1);
		crc32p(&hasht_32[2], &height_2); crc32p(&hasht_32[3], &height_3);
		crc32p(&hasht_32[4], &height_4); crc32p(&hasht_32[5], &height_5); 
		crc32p(&hasht_32[6], &height_6); crc32p(&hasht_32[7], &height_7);
		height_0%=maxHeight; height_1%=maxHeight;
		height_2%=maxHeight; height_3%=maxHeight;
		height_4%=maxHeight; height_5%=maxHeight; 
		height_6%=maxHeight; height_7%=maxHeight;
		hashIter0 = getBlockIdByHeight(height_0); 
		hashIter1 = getBlockIdByHeight(height_1);
		*hasht_64_0 += *hashi0_64_0; *hasht_64_1 += *hashi0_64_1; 
		*hasht_64_2 += *hashi0_64_2; *hasht_64_3 += *hashi0_64_3;
		*hasht_64_0 += *hashi1_64_0; *hasht_64_1 += *hashi1_64_1;
		*hasht_64_2 += *hashi1_64_2; *hasht_64_3 += *hashi1_64_3;
		hashIter0 = getBlockIdByHeight(height_2);
		hashIter1 = getBlockIdByHeight(height_3);
		*hasht_64_0 /= *hashi0_64_0; *hasht_64_1 /= *hashi0_64_1;
		*hasht_64_2 /= *hashi0_64_2; *hasht_64_3 /= *hashi0_64_3; 
		*hasht_64_0 *= *hashi1_64_0; *hasht_64_1 *= *hashi1_64_1;
		*hasht_64_2 *= *hashi1_64_2; *hasht_64_3 *= *hashi1_64_3;
		hashIter0 = getBlockIdByHeight(height_4);
		hashIter0 = getBlockIdByHeight(height_5);
		*hasht_64_0 -= *hashi0_64_0; *hasht_64_1 -= *hashi0_64_1;
		*hasht_64_2 -= *hashi0_64_2; *hasht_64_3 -= *hashi0_64_3;
		*hasht_64_0 -= *hashi1_64_0; *hasht_64_1 -= *hashi1_64_1;
		*hasht_64_2 -= *hashi1_64_2; *hasht_64_3 -= *hashi1_64_3;
		hashIter0 = getBlockIdByHeight(height_6);
		hashIter0 = getBlockIdByHeight(height_7);
		*hasht_64_0 ^= *hashi0_64_0; *hasht_64_1 ^= *hashi0_64_1;
		*hasht_64_2 ^= *hashi0_64_2; *hasht_64_3 ^= *hashi0_64_3;
		*hasht_64_0 ^= *hashi1_64_0; *hasht_64_1 ^= *hashi1_64_1;
		*hasht_64_2 ^= *hashi1_64_2; *hasht_64_3 ^= *hashi1_64_3;
		height_0 &= 0x3F;     height_1 &= 0x3F; 
		height_2 &= 0x3F;     height_3 &= 0x3F; 
		height_4  = 0x40;     height_5  = 0x40;
		height_6  = 0x40;     height_7  = 0x40;
		height_4 -= height_0; height_5 -= height_1;
		height_6 -= height_2; height_7 -= height_3;
		*hasht_64_0 = (hasht_64_0<<height_0) | (hasht_64_0<<height_4);
		*hasht_64_1 = (hasht_64_1<<height_1) | (hasht_64_1<<height_5);
		*hasht_64_2 = (hasht_64_2<<height_2) | (hasht_64_2<<height_6);
		*hasht_64_3 = (hasht_64_3<<height_3) | (hasht_64_3<<height_7);
	}
