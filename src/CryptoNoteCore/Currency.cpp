...
namespace CryptoNote {
  ...
  difficulty_type Currency::nextDifficultyV5(
    ...
    // Consequences of consecutive algos
	...
	bool Currency::checkProofOfWorkV1(Crypto::cn_context& context, const Block& block, difficulty_type currentDiffic, Crypto::Hash& proofOfWork) const {
