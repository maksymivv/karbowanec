...
public:
  ...
  uint32_t upgradeHeightV5() const;
  ...
  uint64_t nextStake(uint32_t height, uint64_t& reward, uint64_t fee, uint64_t& alreadyGeneratedCoins, uint64_t& alreadyGeneratedCoinsBeforeStake) const;
