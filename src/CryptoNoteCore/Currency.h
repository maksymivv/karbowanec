...
public:
  ...
  bool getBlockReward(difficulty_type allTimeAvgDifficulty, difficulty_type currentAvgDifficulty, uint32_t height, uint8_t blockMajorVersion, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins, uint64_t fee,
    uint64_t& reward, int64_t& emissionChange) const;
  size_t maxBlockCumulativeSize(uint64_t height) const;

  bool constructMinerTx(difficulty_type allTimeAvgDifficulty, difficulty_type currentAvgDifficulty, uint8_t blockMajorVersion, uint32_t height, size_t medianSize, uint64_t alreadyGeneratedCoins, size_t currentBlockSize,
