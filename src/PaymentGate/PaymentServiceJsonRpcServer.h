...
private:
  ...
  std::error_code handleOpen(const Open::Request& request, Open::Response& response);
  std::error_code handleClose(const Close::Request& request, Close::Response& response);
