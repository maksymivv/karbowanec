...
private:
  ...
  bool on_prepareblocktemplate(const COMMAND_RPC_PREPARE_BLOCKTEMPLATE::request& req, COMMAND_RPC_PREPARE_BLOCKTEMPLATE::response& res);
  ...
  const CryptoNote::ICryptoNoteProtocolQuery& m_protocolQuery;
