...
#include "sysendian.h"
  ...
  inline int yespower_hash(const void *input, size_t length, char *output) {
    return yespower_tls(reinterpret_cast<uint8_t *>(&input), length, &ypp_v1, (yespower_binary_t *)output);
  }
