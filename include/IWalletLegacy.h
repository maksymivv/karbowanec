...
public:
  ...
  virtual TransactionId sendTransaction(const WalletLegacyTransfer& transfer, std::string& tx_as_hex, uint64_t fee, const std::string& extra = "", uint64_t mixIn = 0, uint64_t unlockTimestamp = 0, bool do_not_relay = false) = 0;
  virtual TransactionId sendTransaction(const std::vector<WalletLegacyTransfer>& transfers, std::string& tx_as_hex, uint64_t fee, const std::string& extra = "", uint64_t mixIn = 0, uint64_t unlockTimestamp = 0, bool do_not_relay = false) = 0;
