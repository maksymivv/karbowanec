...
# Check to see if we have Boost 1.62 ready in our toolchain, if
# not we'll download and build it
echo -n "Checking for Boost 1.62... "
if [ ! -f $TOOLCHAIN_DIR/boost_1_62_0/stage/lib/libboost_system.a ]; then
  echo "Not found... Installing..."
  wget http://sourceforge.net/projects/boost/files/boost/1.62.0/boost_1_62_0.tar.gz
  tar zxvf boost_1_62_0.tar.gz >/dev/null
  cd boost_1_62_0
  echo -n "Bootstrapping Boost 1.62 build... "
...
export BOOST_ROOT=$TOOLCHAIN_DIR/boost_1_62_0
